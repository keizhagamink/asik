    ...
    return (
        <div className='py-5 px-5 md:px-12 lg:px-28 my-8'>
            <div className="py-5 px-5 md:px-12 lg:px-28 text-center my-8 ">
                ...
                <p className='mt-5 mx-w-[740px] m-auto text-xs sm:text-base'>Stay Connected with us.</p>
            </div>
            <div className='gap-10 mx-auto max-w-4xl mt-1'>
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                                ...
                                <div className="mb-3 w-full">
                                    <label className="block font-medium mb-[2px] text-black-700" htmlFor="exampleInput90">
                                        Name
                                    </label>
                                ...
                                <button type="button"
                                    className="mb-6 inline-block w-full rounded border border-black px-6 py-2.5 font-medium leading-normal text-black hover:shadow-md hover:bg-black hover:text-white">
                                    Contact Us
                                </button>
                                    ...
                                    <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                                        <div className="flex items-start">
                                            <div className="shrink-0">
                                                <div className="inline-block rounded-md bg-black-400-100 p-4 text-black-700">
